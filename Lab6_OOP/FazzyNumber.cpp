...
Pair<double>* FazzyNumber::add(Pair* object)
{
...
Pair<double>* FazzyNumber::sub(Pair* object)
{
	FazzyNumber* _object = dynamic_cast<FazzyNumber*>(object);
	first = first + _object->first;
	x = x - _object->x;
...
Pair<double>* FazzyNumber::mul(Pair* object)
{
	FazzyNumber* _object = dynamic_cast<FazzyNumber*>(object);
...
Pair<double>* FazzyNumber::div(Pair* object)
{
	FazzyNumber* _object = dynamic_cast<FazzyNumber*>(object);
