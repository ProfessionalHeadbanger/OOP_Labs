...
Pair<int>* Fraction::add(Pair* object)
{
...
Pair<int>* Fraction::sub(Pair* object)
{
	Fraction* _object = dynamic_cast<Fraction*>(object);
	scale_koef = std::max(scale_koef, _object->scale_koef);
	int left, right;
...
Pair<int>* Fraction::mul(Pair* object)
{
	Fraction* _object = dynamic_cast<Fraction*>(object);
	int left, right;
	Merge(*_object, left, right, '*');
...
Pair<int>* Fraction::div(Pair* object)
{
	Fraction* _object = dynamic_cast<Fraction*>(object);
	int left, right;
	Merge(*_object, left, right, '/');
